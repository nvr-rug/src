...
class AMR(object):
    ...
    def parse_AMR_line(line):
        ...
        for i, c in enumerate(line.strip()):
            #print 'state', state, 'char', c
            #print 'cur rel', cur_relation_name
            if c == " ":
            ...
            if c == "\"":
                ...
                cur_relation_name = ""
                state = 0
                #print 'Set cur_relation to empty and state to 0'
                #print 'prev_chars', line.strip()[i-4], line.strip()[i-3], line.strip()[i-2], line.strip()[i-1] 
            else:
