...
parser.add_argument("-f", required=True, type=str, help="AMR file that needs to be single")
parser.add_argument("-out_ext", default = '.ol', type=str, help="Single output file")
