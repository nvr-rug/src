...
def process_file(f):
	fixed_amrs = []
	prev_ch = ''
	#sents = [x.strip() for x in open('/home/p266548/Documents/amr_Rik/Exp_OMT/Combinations/data_files/training_aligned_upper/silver_camr_jamr_AMR_constant_100k.sent','r')]
	#print len(sents)
