...
parser.add_argument("-input_ext", default = '.restore.pruned',  required=False, type=str, help="Input extension of AMRs (default .restore.wiki)")
...
def process_file(f):
	...
	valid, invalid, replace_possible_count, no_replace, yes_replace = 0, 0, 0, 0, 0
	coref_amrs = []
	...
	print '{0}/{1} were valid'.format(valid, valid + invalid)			
