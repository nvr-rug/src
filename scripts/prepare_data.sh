...
#python $python_path$char_script -f $working_train -output_ext $output_ext -input_ext $input_ext -brackets true
...
#python $python_path$char_script -f $working_dev -output_ext $output_ext -input_ext $input_ext -brackets true
...
#python $python_path$char_script -f $working_test -output_ext $output_ext -input_ext $input_ext -brackets true
